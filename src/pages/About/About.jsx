    ...
    return(
        ...
        <Row className="about-container">
            ...
            <Col  className="about-text-container" lg={5} md={12}  xs={11}>
                <h4 style={{ color: "#FF479A" }}>Breaking Code, Building Success</h4>
                 {/* <h3 style={{ color: "#FF479A" }}>A Web Developer based in the US</h3> */}
                 <h4 style={{ color: "gray" }}>A Transnational Journey in Tech</h4> 
                ...
                <div className="icons-container">
                    <a className="icon" href="https://github.com/camilasandovals" target="_blank" style={{ marginRight: "10%" }}>
                    <Github size={38} color="#6b0080" />
                    </a>
                    <a className="icon" href="https://www.linkedin.com/in/camilasandovals/" target="_blank" style={{ marginRight: '10%' }}>
                    <Linkedin size={38} color="#6b0080" />
                    </a>
                    <a className="icon" href="https://www.instagram.com/foreigncoders/" target="_blank" style={{ marginRight: '10%' }}>
                    <Instagram size={38} color="#6b0080" />
                    </a>
